...
public class ES2Init : MonoBehaviour
{
	...
	public static void Init()
	{
		...
		ES2TypeManager.types[typeof(AchievementData)] = new ES2UserType_AchievementData();
		ES2TypeManager.types[typeof(AnimateScript)] = new ES2UserType_AnimateScript();
		ES2TypeManager.types[typeof(CharStats)] = new ES2UserType_CharStats();
		ES2TypeManager.types[typeof(QuestObject)] = new ES2UserType_QuestObject();
		ES2TypeManager.types[typeof(UnityEngine.SocialPlatforms.Impl.Achievement)] = new ES2UserType_UnityEngineSocialPlatformsImplAchievement();
		ES2TypeManager.types[typeof(AchievementMeta)] = new ES2UserType_AchievementMeta();
